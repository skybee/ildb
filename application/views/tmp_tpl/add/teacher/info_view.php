...
<div class="studen_cart_info studen_cart_info_upd">
    ...
    <table class="student_cart_info_tbl group_cart_info_tbl">
        ...
        <tr>
            ...
            <td>
                <select name="tmp[]" class="greyselect" style="width:220px" multiple="multiple">
        ...
        <tr>
            ...
            <td>
                <select name="tmp[]" class="greyselect" style="width:220px">
        ...
        <tr>
            ...
            <td><input type="text" name="tmp[]" value="10.06.2011" class="greyinput date_input_all" style="width:180px" /></td>
        </tr>
        <tr>
            <td>Начало работы</td>
            <td><input type="text" name="tmp[]" value="14.08.2011" class="greyinput date_input_all" style="width:180px" /></td>
        </tr>
        <tr>
            <td colspan="2" class="info_space"></td>
        </tr>
        <tr>
            <td>Вторая работа</td>
            <td><input type="text" name="tmp[]" class="greyinput" style="width:180px" /></td>
        </tr>
        <tr>
