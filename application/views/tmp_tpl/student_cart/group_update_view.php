            ...
            <td rowspan="2" style="padding-top: 0">
                <div class="st_cart_paus_in_group_block">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="payment_add_date_block st_cart_paus_date_input_block">
                                    <input type="text" name="date[]"  class="greyinput date_input" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table class="add_payment_btn_tbl pause_student_confirm_tbl">
                        <tr>
                            <td>
                                <a href="#" class="btn_add_payment">Добавить паузу</a>
                            </td>
                            <td>
...
<div class="studen_cart_info studen_cart_add_to_group_block">
    ...
    <div style="margin-top: 17px;">
        <select name="tmp[]" class="greyselect" style="width: 330px;">
            <option value="1">Crazy Star Pearls En A1</option>
            <option value="1">Crazy Star Pearls En A1</option>
            <option value="1">Crazy Star Pearls En A1</option>
            <option value="1">Crazy Star Pearls En A1</option>
            <option value="1">Crazy Star Pearls En A1</option>
        ...
        <tr>
            ...
            <td>
                <div class="payment_add_date_block">
                    <input type="text" class="greyinput date_input" name="tmp[]" style="width: 70px;" />
                </div>
            </td>
        </tr>
    </table>
    
    <table class="add_payment_btn_tbl">
        <tr>
            <td>
                <a href="#" class="btn_add_payment">Добавить в группу</a>
            </td>
            <td>
                <a href="#">Отмена</a>
            </td>
